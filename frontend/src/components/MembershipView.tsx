        ...
        {discordTiers.map((tier) => {
          ...
          return (
            <div
              ...
              key={tier.id}
              className={`relative group rounded-2xl p-8 flex flex-col justify-between overflow-hidden backdrop-blur-md transition-all duration-300 border ${isDarkMode
            ...
            >
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    <div
                      ...
                      className={`p-2.5 rounded-xl border flex items-center justify-center ${isHighlighted
                        ? 'border-[#FA5F88]/30'
              ...
              <button
                ...
                className={`relative z-10 w-full py-3.5 mt-8 font-mono text-xs tracking-widest font-bold rounded-xl transition-all cursor-pointer shadow-lg flex items-center justify-center space-x-2 ${isHighlighted
