    ...
    switch (theme) {
      case 'neon-mint':
        return {
          ...
          accentTextMuted: 'text-emerald-700/80',
          ...
          badgeStyles: 'text-emerald-800 bg-emerald-50/90 border border-emerald-300/60 backdrop-blur-md font-bold',
          taglineText: 'text-emerald-800',
          taglineBg: 'bg-emerald-100/80',
          taglineBorder: 'border-emerald-300/60',
          ...
          chamberStatuses: {
            vault1: 'text-emerald-700 border-emerald-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault2: 'text-cyan-700 border-cyan-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault3: 'text-emerald-700 border-emerald-300/60 bg-white/80 backdrop-blur-md font-bold'
          },
          textPrimary: 'text-zinc-950',
          textSecondary: 'text-zinc-800',
          textMuted: 'text-zinc-600',
          bgMain: 'bg-emerald-50/30 backdrop-blur-3xl',
          bgCard: 'bg-white/85 border border-emerald-300/50 backdrop-blur-xl shadow-lg shadow-emerald-900/5',
          borderMain: 'border-emerald-300/70',
          borderMuted: 'border-emerald-200/60',
          bgHeader: 'bg-white/80 border-b border-emerald-200/60 backdrop-blur-md shadow-xs',
          bgFooter: 'bg-emerald-50/90 border-t border-emerald-200/60 backdrop-blur-md',
          drawerOverlay: 'bg-white/95 shadow-[0_15px_30px_rgba(0,0,0,0.15)] border border-emerald-200'
        };
      case 'crimson-moon':
        return {
          accentText: 'text-red-600',
          accentTextMuted: 'text-red-700/80',
          accentBg: 'bg-red-500',
          ...
          badgeStyles: 'text-red-800 bg-red-50/90 border border-red-300/60 backdrop-blur-md font-bold',
          taglineText: 'text-red-800',
          taglineBg: 'bg-red-100/80',
          taglineBorder: 'border-red-300/60',
          ...
          chamberStatuses: {
            vault1: 'text-red-700 border-red-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault2: 'text-rose-700 border-rose-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault3: 'text-red-700 border-red-300/60 bg-white/80 backdrop-blur-md font-bold'
          },
          textPrimary: 'text-zinc-950',
          textSecondary: 'text-zinc-800',
          textMuted: 'text-zinc-600',
          bgMain: 'bg-red-50/30 backdrop-blur-3xl',
          bgCard: 'bg-white/85 border border-red-300/50 backdrop-blur-xl shadow-lg shadow-red-900/5',
          borderMain: 'border-red-300/70',
          borderMuted: 'border-red-200/60',
          bgHeader: 'bg-white/80 border-b border-red-200/60 backdrop-blur-md shadow-xs',
          bgFooter: 'bg-red-50/90 border-t border-red-200/60 backdrop-blur-md',
          drawerOverlay: 'bg-white/95 shadow-[0_15px_30px_rgba(0,0,0,0.15)] border border-red-200'
        };
      case 'monochrome':
        return {
          accentText: 'text-zinc-900',
          accentTextMuted: 'text-zinc-800/80',
          ...
          badgeStyles: 'text-zinc-900 bg-zinc-100 border border-zinc-300/80 backdrop-blur-md font-bold',
          taglineText: 'text-zinc-900',
          taglineBg: 'bg-zinc-200/80',
          taglineBorder: 'border-zinc-300',
          ...
          chamberStatuses: {
            vault1: 'text-zinc-800 border-zinc-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault2: 'text-zinc-900 border-zinc-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault3: 'text-zinc-800 border-zinc-300/60 bg-white/80 backdrop-blur-md font-bold'
          },
          textPrimary: 'text-zinc-950',
          textSecondary: 'text-zinc-800',
          textMuted: 'text-zinc-600',
          bgMain: 'bg-zinc-100/30 backdrop-blur-3xl',
          bgCard: 'bg-white/85 border border-zinc-300/70 backdrop-blur-xl shadow-lg shadow-black/5',
          borderMain: 'border-zinc-300/80',
          borderMuted: 'border-zinc-200/70',
          bgHeader: 'bg-white/80 border-b border-zinc-200/70 backdrop-blur-md shadow-xs',
          bgFooter: 'bg-zinc-100/90 border-t border-zinc-200/70 backdrop-blur-md',
          drawerOverlay: 'bg-white/95 shadow-[0_15px_30px_rgba(0,0,0,0.15)] border border-zinc-200'
        };
      case 'classic':
      default:
        return {
          accentText: 'text-rose-600',
          accentTextMuted: 'text-rose-700/80',
          ...
          badgeStyles: 'text-rose-800 bg-rose-50/90 border border-rose-300/60 backdrop-blur-md font-bold',
          taglineText: 'text-rose-800',
          taglineBg: 'bg-rose-100/80',
          taglineBorder: 'border-rose-300/60',
          ...
          chamberStatuses: {
            vault1: 'text-rose-700 border-rose-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault2: 'text-emerald-700 border-emerald-300/60 bg-white/80 backdrop-blur-md font-bold',
            vault3: 'text-rose-700 border-rose-300/60 bg-white/80 backdrop-blur-md font-bold'
          },
          textPrimary: 'text-zinc-950',
          textSecondary: 'text-zinc-800',
          textMuted: 'text-zinc-600',
          bgMain: 'bg-rose-50/30 backdrop-blur-3xl',
          bgCard: 'bg-white/85 border border-rose-300/50 backdrop-blur-xl shadow-lg shadow-rose-900/5',
          borderMain: 'border-rose-300/70',
          borderMuted: 'border-rose-200/60',
          bgHeader: 'bg-white/80 border-b border-rose-200/60 backdrop-blur-md shadow-xs',
          bgFooter: 'bg-rose-50/90 border-t border-rose-200/60 backdrop-blur-md',
          drawerOverlay: 'bg-white/95 shadow-[0_15px_30px_rgba(0,0,0,0.15)] border border-rose-200'
        };
    }
  }
};
